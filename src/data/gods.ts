...
export const GODS: God[] = [
  {
    ...
    // Trône en haut — calibré sur Olympe finale +
    hotspot: { x: 50.3, y: 16.6, w: 16.5, h: 21 },
  ...
  },
  {
    ...
    // Centre bas — calibré sur Olympe finale +
    hotspot: { x: 48.9, y: 82, w: 7.6, h: 29.6 },
  ...
  },
  {
    ...
    // Centre-gauche bas — calibré sur Olympe finale +
    hotspot: { x: 35.2, y: 81.5, w: 7.1, h: 28 },
  ...
  },
  {
    ...
    // Centre-droite bas — calibré sur Olympe finale +
    hotspot: { x: 60.9, y: 80.3, w: 6.5, h: 32.9 },
  ...
  },
  {
    ...
    // Calibré sur Olympe finale +
    hotspot: { x: 25.6, y: 52.8, w: 5.9, h: 22.5 },
  ...
  },
  {
    ...
    // Calibré sur Olympe finale +
    hotspot: { x: 74.6, y: 51.7, w: 4.9, h: 22.5 },
  ...
  },
  {
    ...
    // Calibré sur Olympe finale +
    hotspot: { x: 14.7, y: 51.3, w: 7.2, h: 23.8 },
  ...
  },
  {
    ...
    palette: { primary: '#d4a73b', accent: '#ffe8a3', flame: '#ffc94a' },
    // Calibré sur Olympe finale +
    hotspot: { x: 85.9, y: 49.4, w: 6.1, h: 24.2 },
