...
export const GODS: God[] = [
  {
    ...
    // Trône en haut — calibré par Julien
    hotspot: { x: 50.6, y: 23.8, w: 11.5, h: 35.6 },
  ...
  },
  {
    ...
    // Centre bas — calibré par Julien
    hotspot: { x: 49.4, y: 70.1, w: 8.6, h: 20.7 },
  ...
  },
  {
    ...
    // Centre-gauche bas — calibré par Julien
    hotspot: { x: 31.4, y: 70.4, w: 9.3, h: 24.9 },
  ...
  },
  {
    ...
    // Centre-droite bas — calibré par Julien
    hotspot: { x: 66.5, y: 70.6, w: 9.4, h: 16.9 },
  ...
  },
  {
    ...
    // Calibré par Julien
    hotspot: { x: 22, y: 30.5, w: 7.7, h: 23.3 },
  ...
  },
  {
    ...
    // Calibré par Julien
    hotspot: { x: 78.1, y: 27.5, w: 7.2, h: 24 },
  ...
  },
  {
    ...
    // Calibré par Julien
    hotspot: { x: 9.2, y: 26.7, w: 7, h: 25.2 },
  ...
  },
  {
    ...
    palette: { primary: '#d4a73b', accent: '#ffe8a3', flame: '#ffc94a' },
    // Calibré par Julien
    hotspot: { x: 91.8, y: 26.4, w: 8.7, h: 26.8 },
